"""
Лабораторна робота 7. Завдання 7.1
...
input_file = '!materials/data_singlevar_regr.txt'
...
plt.legend()
plt.grid(True)
plt.savefig('task_7_1_plot.png', dpi=300, bbox_inches='tight')
plt.show()

# Обчислюємо метричні параметри регресора
print("Метрики якості регресора:")
