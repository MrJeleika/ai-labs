"""
Лабораторна робота №9. Завдання 9.1
...
if __name__ == '__main__':
    ...
    # Залежно від того, яке значення вхідного параметра ми задали,
    # класифікатор конструюється на основі випадкового або граничного випадкового лісу.
    ...
    # Обчислюємо результати на тестовому наборі даних та візуалізуємо його
    ...
    # Об'єкт класифікатора має вбудований метод, призначений для
    # обчислення рівнів довірливості. Класифікуємо кожну точку та обчислимо рівні довірливості.
    print("\nConfidence measure:")
